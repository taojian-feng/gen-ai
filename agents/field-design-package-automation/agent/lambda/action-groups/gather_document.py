...
def send_document_url(fdp_id):
    print("Send Document URL")

    subject = "Gathering Documents for FPD ID: " + fdp_id
    message = "Please upload your FDP documents: " + url
...
def lambda_handler(event, context):
    ...
    # API path routing
    if api_path == '/fdps/{fdpId}/gather-document':
